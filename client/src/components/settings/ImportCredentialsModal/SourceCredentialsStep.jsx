...
/**
 * SourceCredentialsStep Component
 * Step component for collecting source instance credentials
 */
function SourceCredentialsStep({
  instances,
  credentials,
  errors,
  onUpdateCredential,
  ...
  return (
    <div className={styles.stepContent}>
      ...
      {instances.map((instance, index) => {
        const cred = credentials.sourceInstances?.[index] || {};
            ...
            {authType === "apikey" ? (
              <div className={styles.formGroup}>
                ...
                <Input
                  ...
                  error={errors[`source_${index}_apiKey`]}
                />
              </div>
            ) : (
              <>
                <div className={styles.formGroup}>
                  ...
                  <Input
                    ...
                    error={errors[`source_${index}_username`]}
                  />
                </div>
                <div className={styles.formGroup}>
                  ...
                  <Input
                    ...
                    error={errors[`source_${index}_password`]}
                  />
                </div>
              </>
            )}
...
SourceCredentialsStep.propTypes = {
...
export default SourceCredentialsStep;
