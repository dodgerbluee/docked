...
/**
 * Card component for displaying source instance statistics
 ...
 */
const SourceInstanceCard = ({ instance, onInstanceClick, onStatClick }) => {
...
export default memo(SourceInstanceCard);
