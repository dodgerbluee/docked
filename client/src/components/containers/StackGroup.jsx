...
import SourceContainerCard from "./SourceContainerCard";
import { STACK_NAMES } from "../../constants/containersPage";
import styles from "./StackGroup.module.css";

/**
 * StackGroup Component
 * Displays a group of containers organized by stack
 */
const StackGroup = React.memo(function StackGroup({
  stack,
  containers,
  showUpdates,
  collapsed,
