...
/**
 * Custom hook for handling new source instance creation
 ...
 * @param {Function} params.setSourceInstancesFromAPI - Setter for source instances
 ...
 * });
 */
export const useNewSourceInstance = ({
  setSourceInstancesFromAPI,
  setContainers,
  setStacks,
  ...
  const handleNewInstanceDataFetch = useCallback(
    async (newInstanceData) => {
      ...
      if (newInstanceData.id && newInstanceData.url) {
        ...
        // This will automatically fetch from the source and Docker Hub for this instance
        ...
        try {
          ...
          // If Docker Hub pull fails, still try to fetch from source to get basic data
          console.error("Error pulling Docker Hub data for new instance:", pullErr);
          try {
            // Fetch from source only to get basic container data
            ...
            console.error("Error fetching source data for new instance:", fetchErr);
