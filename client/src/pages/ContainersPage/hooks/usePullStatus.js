/**
 * Hook for managing pull status and checkmark
 */
...
export const usePullStatus = ({
  ...
  // Handler for sources-only data update (no Docker Hub)
  const handlePullSourcesOnly = useCallback(async () => {
    try {
      setPullingSourcesOnly(true);
      setLocalPullError("");
