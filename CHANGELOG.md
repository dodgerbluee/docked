...
- Automatic update detection for Docker containers
- Modern React-based UI
- Batch processing system for automated updates
- Discord notification support
- Tracked applications management
- Docker Hub integration
- Unused image detection and cleanup
