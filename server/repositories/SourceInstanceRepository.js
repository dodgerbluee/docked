 ...
 * Handles all source instance database operations
 */

const BaseRepository = require("./BaseRepository");

class SourceInstanceRepository extends BaseRepository {
  /**
   * Find all source instances
...
module.exports = SourceInstanceRepository;
