...
function hashApiKey(apiKey) {
  ...
  // separately for outbound auth to the runner. lgtm[js/weak-cryptographic-algorithm]
  return crypto.createHash("sha256").update(apiKey).digest("hex"); // lgtm[js/weak-cryptographic-algorithm]
}
